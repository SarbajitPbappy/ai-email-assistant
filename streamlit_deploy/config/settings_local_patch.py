"""
Paste this into your LOCAL config/settings.py to make it write
to the cloud PostgreSQL database instead of local SQLite.

Just change DATABASE_URL in your config/.env file:
...
class Settings(BaseSettings):
    ...
    # 👇 This is the only line that matters — point it to Supabase
